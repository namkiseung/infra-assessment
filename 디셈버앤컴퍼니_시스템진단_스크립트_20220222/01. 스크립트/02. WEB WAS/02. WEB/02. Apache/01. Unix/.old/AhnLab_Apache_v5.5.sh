...
echo "APACHE is disabled" >> ./$RES_LAST_FILE 2>&1					
else
...
#ErrorLog_EX=`cat $HTTPD_ROOT/conf/extra/httpd-vhosts.conf | grep ErrorLog | grep -v '#' | awk -F' ' '{print $2}'`
#CustomLog_EX=`cat $HTTPD_ROOT/conf/extra/httpd-vhosts.conf | grep CustomLog | grep -v '#' | awk -F'"' '{print $2}'`
extra_conf=`cat $HTTPD_CONF | grep -v '#' | grep Include | awk -F' ' '{print $2}'`
fi
...
#ErrorLog_EX=`cat $VirtualHost_PATH | grep ErrorLog | grep -v '#' | awk -F' ' '{print $2}'`
#CustomLog_EX=`cat $VirtualHost_PATH | grep CustomLog | grep -v '#' | awk -F' ' '{print $2}'`
fi


echo SYSTEM LINUX APACHE HeaderInfo {ahnlab{ >> ./$RES_LAST_FILE 2>&1 
...
echo $ServerRoot 								 														>> ./$RES_LAST_FILE 2>&1
ls -ald $ServerRoot																						>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo "---------------< DocumentRoot >---------------"														>> ./$RES_LAST_FILE 2>&1
echo $DocumentRoot							 															>> ./$RES_LAST_FILE 2>&1
ls -ald $DocumentRoot																					>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo "---------------< VirtualHost Root >---------------"													>> ./$RES_LAST_FILE 2>&1
if [ $INCLUDE_FLAG -ge 1 ]; then
echo $EXTRA_CONF_FILES																				>> ./$RES_LAST_FILE 2>&1

for dir in $EXTRA_CONF_FILES
do 
if [ `cat $dir | grep -v '#' | grep "DocumentRoot" | wc -l` -ge 1 ]; then
EXTRA_CONF_FILES_DocumentRoot=`cat $dir | grep -v '#' | grep "DocumentRoot" | cut -f2 -d" "`
for dir2 in $EXTRA_CONF_FILES_DocumentRoot
do
ls -ald $dir2                                    										>> ./$RES_LAST_FILE 2>&1
done
fi
done
fi
...
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo "---------------< Configuration File >---------------"													>> ./$RES_LAST_FILE 2>&1
ls -al $HTTPD_CONF 																						>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
...
echo $ErrorLog                                              											>> ./$RES_LAST_FILE 2>&1
for dir in $ErrorLog
do																										>> ./$RES_LAST_FILE 2>&1
ls -al $HTTPD_ROOT/$dir
done																									>> ./$RES_LAST_FILE 2>&1
ls -al $ErrorLog																						>> ./$RES_LAST_FILE 2>&1
...
ls -al $CustomLog																						>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
...
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo "---------------< Options >---------------"															>> ./$RES_LAST_FILE 2>&1
(cat $HTTPD_CONF | grep -v '#' | grep -v IndexOptions | grep Options | FollowSymLinks)					>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo "---------------< Directory >---------------"															>> ./$RES_LAST_FILE 2>&1	
(cat $HTTPD_CONF | grep -v '#' | grep 'Directory ')														>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
...
echo "---------------< ServerTokens (extra/httpd-default.conf)>---------------"								>> ./$RES_LAST_FILE 2>&1
for dir in $EXTRA_CONF_FILES
do 
...
echo "---------------< ServerSignature (extra/httpd-default.conf) >---------------"							>> ./$RES_LAST_FILE 2>&1	
for dir in $EXTRA_CONF_FILES
do 
...
(cat $HTTPD_CONF | grep -v '#' | grep -i allowoveride)													>> ./$RES_LAST_FILE 2>&1
