...
TOMCAT_DIR_LEE2=`ps -ef | grep catalina`
for dir in $TOMCAT_DIR_LEE2
do
...
ls -alF $TOMCAT_DIR/webapps/ | grep -i manager											 				>> ./$RES_LAST_FILE 2>&1
echo " " 																									>> ./$RES_LAST_FILE 2>&1
echo "---------------< 웹 서버 홈 디렉터리 ($TOMCAT_DIR/$appbase) >---------------"							>> ./$RES_LAST_FILE 2>&1
echo 'appBase :' $appbase																				>> ./$RES_LAST_FILE 2>&1
echo $dir 																								>> ./$RES_LAST_FILE 2>&1
ls -alR $TOMCAT_DIR/$dir						 														>> ./$RES_LAST_FILE 2>&1
ls -alR $dir 																							>> ./$RES_LAST_FILE 2>&1
...
ls -alF $TOMCAT_DIR/conf/*.xml *.properties *.policy								 					>> ./$RES_LAST_FILE 2>&1

echo "---------------< 1.2 소스파일 ($TOMCAT_DIR/$appbase) >---------------"									>> ./$RES_LAST_FILE 2>&1
ls -alR $TOMCAT_DIR/$appbase								 											>> ./$RES_LAST_FILE 2>&1
