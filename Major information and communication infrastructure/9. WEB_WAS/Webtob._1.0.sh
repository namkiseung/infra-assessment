...
echo ""
echo "###########################################################################"
echo "#        Copyright (c) 2018 SK think Co. Ltd. All Rights Reserved.       #"
echo "###########################################################################"
echo ""
echo ""
...
echo "#                         Copyright (c) 2018 SK think Co. Ltd. All Rights Reserved.                     #" >> $CREATE_FILE_RESULT 2>&1
echo "########################################################################################################" >> $CREATE_FILE_RESULT 2>&1
...
echo '===================================================================' >> $CREATE_FILE_RESULT 2>&1
echo 'Log의 경로 확인하여 해당 Log디렉터리의 퍼미션이 750이하이거나 로그파일 퍼미션이 640이하인지 확인' >> $CREATE_FILE_RESULT 2>&1
echo '' >> $CREATE_FILE_RESULT 2>&1
